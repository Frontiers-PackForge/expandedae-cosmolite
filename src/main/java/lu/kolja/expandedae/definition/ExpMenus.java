...
public class ExpMenus {
    ...
    public static final MenuType<ExpPatternProviderMenu> EXP_PATTERN_PROVIDER =
            create("exp_pattern_provider", ExpPatternProviderMenu::new, PatternProviderLogicHost.class);
