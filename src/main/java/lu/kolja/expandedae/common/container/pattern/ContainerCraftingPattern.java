package lu.kolja.expandedae.common.container.pattern;

import appeng.api.stacks.GenericStack;
import appeng.crafting.pattern.AECraftingPattern;
import lu.kolja.expandedae.Expandedae;
import lu.kolja.expandedae.util.Ae2Reflect;
...
public class ContainerCraftingPattern extends ContainerPattern {
    ...
    public static final ResourceLocation ID = Expandedae.id("craft_pattern");
