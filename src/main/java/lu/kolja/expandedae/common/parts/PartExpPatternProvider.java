package lu.kolja.expandedae.common.parts;
...
public class PartExpPatternProvider extends AEBasePart implements PatternProviderLogicHost {
    ...
    public PartExpPatternProvider(IPartItem<?> partItem) {
        super(partItem);
    ...
    public ItemStack getMainMenuIcon() {
        return new ItemStack(EAEItemAndBlock.EXP_PATTERN_PROVIDER_PART);
    }
}
