...
public class ExpHighlightHandler {
    private static final ColorData RED = new ColorData(1f, 0f, 1f);
    ...
    public static void highlight(BlockPos pos, Direction face, ResourceKey<Level> dim, long time, AABB box) {
        HighlightHandler.highlight(pos, face, dim, time, box, RED, ExpHighlightHandler::blink);
    }
